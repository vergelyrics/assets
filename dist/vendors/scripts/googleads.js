(function (window, document) {
   ...
   */
  const adSlotsConfig = {
    slot1: { slotId: '6361622853', desktop: { style: 'display:inline-block;width:728px;height:90px' }, mobile: { style: 'display:block;width:728px;height:90px;', format: 'auto' } },
    slot2: { slotId: '2324490715', desktop: { style: 'display:inline-block;width:728px;height:90px' }, mobile: { style: 'display:block;width:728px;height:90px;', format: 'auto' } },
    slot3: { slotId: '5472881313', desktop: { style: 'display:inline-block;width:728px;height:90px' }, mobile: { style: 'display:block;width:728px;height:90px;', format: 'auto' } },
    slot4: { slotId: '5015330716', desktop: { style: 'display:inline-block;width:300px;height:250px' }, mobile: { style: 'display:block;width:300px;height:250px;', format: 'auto' } },
    slot5: { slotId: '9809327123', desktop: { style: 'display:inline-block;width:300px;height:250px' }, mobile: { style: 'display:block;width:300px;height:250px;', format: 'auto' } },
  };
  ...
  function loadAd(container, slotConfig) {
    ...
    let adHTML;
    if (DEMO_MODE) {
      adHTML = `<ins class="adB">Demo Ad: ${slotConfig.slotId} (${isDesktop ? 'Desktop' : 'Mobile'})</ins>`;
    } else {
      adHTML = `<ins class="adsbygoogle" ${styleAttr}
  ...
  /**
   * Observe all valid ad containers
   */
