(function loadDynamicGPT(){
  ...
  style.textContent=`.gpt-loaded .vTheme{padding-bottom:calc(8rem + 70px)} .gpt-loaded .layoutH > *{padding-bottom:0px!important} .gpt-ads{bottom:70px;max-height:90px;overflow:hidden;background-color:transparent} .gpt-in{min-height:90px} .gpt-in > *{max-height:90px;background-color:var(--border-color)}`;
